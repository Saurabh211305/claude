    ...
    <section className="bg-paper py-24 text-ink md:py-32">
      <div className="container-fluid grid grid-cols-1 gap-16 lg:grid-cols-2 lg:gap-20">
        <div>
          ...
          <h2 className="font-display max-w-md text-[clamp(1.9rem,3.6vw,2.75rem)] font-light leading-[1.08] text-ink">
            <TextReveal lines={["Why Investors Choose", "Trixis Homes"]} />
          </h2>
          <Reveal delay={0.15} className="mt-6 max-w-md text-base leading-relaxed text-ink/60">
        ...
        <div>
          ...
          <h3 className="font-display max-w-md text-[clamp(1.6rem,3vw,2.25rem)] font-light leading-[1.15] text-ink">
            <TextReveal lines={["Investors Shaping Their Future", "Through Dubai Real Estate."]} />
          </h3>

          <Reveal delay={0.2} className="mt-8 rounded-sm border border-ink/10 bg-paper-dim p-8">
            <p dir="rtl" className="font-display text-xl italic leading-relaxed text-ink">
