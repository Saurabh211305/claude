  ...
  return (
    <section className="bg-midnight py-24 text-paper md:py-32">
      <div className="container-fluid">
        ...
        <h2 className="font-display mx-auto max-w-2xl text-center text-[clamp(1.9rem,3.6vw,2.75rem)] font-light leading-[1.1] text-paper">
        ...
        <Reveal delay={0.15} className="mx-auto mt-14 max-w-2xl text-center">
          ...
          <p dir="rtl" className="font-display text-2xl italic leading-relaxed text-paper">
        ...
        <Reveal delay={0.25} className="mx-auto mt-16 grid max-w-3xl grid-cols-2 gap-6 border-t border-paper/10 pt-12 sm:grid-cols-4">
          {PROOF.map((p) => (
            <div key={p.label} className="text-center">
              ...
              />
              <p className="mt-1.5 text-xs uppercase tracking-wide text-paper/50">{p.label}</p>
            </div>
          ))}
        </Reveal>
      </div>
