      ...
      <div className="container-fluid relative grid grid-cols-1 gap-16 lg:grid-cols-[1fr_1fr] lg:gap-24">
        <div>
          ...
          <Reveal delay={0.25} className="mt-10 space-y-4">
            {CHECKLIST.map((item) => (
              <div key={item} className="flex items-center gap-3 text-paper/75">
        ...
        <Reveal delay={0.1}>
          <div className="rounded-sm border border-paper/10 bg-midnight-elevated/60 p-8 backdrop-blur-md md:p-10">
            {submitted ? (
              <motion.div
              ...
              >
                ...
                <button
                  type="submit"
                  data-cursor="Send"
                  className="group flex w-full items-center justify-center gap-3 rounded-sm bg-gold px-8 py-4 text-sm font-medium tracking-wide text-midnight transition-transform duration-300 hover:scale-[1.02]"
                >
