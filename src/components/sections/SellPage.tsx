...
export default function SellPage() {
  ...
  return (
    <>
      <section className="bg-paper pb-20 pt-32 text-ink md:pb-28 md:pt-40">
        <div className="container-fluid grid grid-cols-1 gap-16 lg:grid-cols-2">
          <div>
            ...
            <h1 className="font-display text-[clamp(2.2rem,5vw,3.5rem)] font-light leading-[1.05] text-ink">
              <TextReveal lines={["Sell with confidence,", "not guesswork."]} />
            </h1>
            <Reveal delay={0.15} className="mt-6 max-w-md text-base leading-relaxed text-ink/65">
              ...
              {BENEFITS.map((b) => (
                <StaggerItem key={b.title} className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm leading-relaxed text-ink/55">{b.description}</p>
                  </div>
                </StaggerItem>
              ))}
            </StaggerGroup>
