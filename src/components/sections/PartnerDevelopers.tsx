      ...
      <div className="container-fluid">
        <div className="flex flex-col items-start justify-between gap-6 md:flex-row md:items-end">
          <div>
            ...
            <h2 className="font-display max-w-lg text-[clamp(1.9rem,3.6vw,2.75rem)] font-light leading-[1.1] text-paper">
          ...
          {DEVELOPERS.map((dev) => (
            <StaggerItem key={dev.slug}>
              <Link
                ...
                data-cursor="View"
                className="group flex h-full flex-col justify-between rounded-sm border border-paper/10 bg-paper/[0.03] p-6 transition-colors hover:border-gold/40"
              >
                <p className="font-display text-lg text-paper">{dev.name}</p>
